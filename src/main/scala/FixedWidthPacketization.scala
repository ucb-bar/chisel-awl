...
/*
// TODO DO NOT USE
class FixedWidthPacketizerMaster[P <: DecodedSymbol, T <: Data](val decodedSymbolsPerCycle: Int, symbolFactory: () => P, dataFactory: () => T) extends Packetizer(symbolFactory, dataFactory) {
